...
START=$(date +%s)
python $vcf_compare_dir/vcf_compare_OLD.py -r $reference/ucsc.hg19.fasta -g $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.vcf -w $results/p5_Haplotypecaller/vars_default_alinged_deduped.vcf -o default_aligned_deduped_neat $results/tmp --incl-homs --incl-fail  -t $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.bed -T 90 --vcf-out --no-plot
END=$(date +%s)
DIFF=$(( $END - $START ))
exitcode=$?
...
### 2.
START=$(date +%s)
python $vcf_compare_dir/vcf_compare_OLD.py -r $reference/ucsc.hg19.fasta -g $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.vcf -w $results/p5_Haplotypecaller/vars_ics7_best_bqsr.vcf -o best_bqsr_ics7_neat $results/tmp --incl-homs --incl-fail  -t $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.bed -T 90 --vcf-out --no-plot
END=$(date +%s)
DIFF=$(( $END - $START ))
exitcode=$?
...
## 3.
START=$(date +%s)
python $vcf_compare_dir/vcf_compare_OLD.py -r $reference/ucsc.hg19.fasta -g $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.vcf -w $results/p5_Haplotypecaller/vars_bqsrBAQGOP20_worst_bqsr.vcf -o worst_bqsr_bqsrBAQGOP20_neat $results/tmp --incl-homs --incl-fail  -t $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.bed -T 90 --vcf-out --no-plot
END=$(date +%s)
DIFF=$(( $END - $START ))
exitcode=$?
...
## 3b.
START=$(date +%s)
python $vcf_compare_dir/vcf_compare_OLD.py -r $reference/ucsc.hg19.fasta -g $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.vcf -w $results/p5_Haplotypecaller/vars_bqsr_default_bqsr.vcf -o default_bqsr_neat $results/tmp --incl-homs --incl-fail  -t $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.bed -T 90 --vcf-out --no-plot
END=$(date +%s)
DIFF=$(( $END - $START ))
exitcode=$?
...
## 4.
START=$(date +%s)
python $vcf_compare_dir/vcf_compare_OLD.py -r $reference/ucsc.hg19.fasta -g $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.vcf -w $results/p5_Haplotypecaller/vars_default_aligned.vcf -o default_aligned_neat $results/tmp --incl-homs --incl-fail  -t $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.bed -T 90 --vcf-out --no-plot
...
## 5.
START=$(date +%s)
python $vcf_compare_dir/vcf_compare_OLD.py -r $reference/ucsc.hg19.fasta -g $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.vcf -w $results/p5_Haplotypecaller/vars_worst_aligned_U4.vcf -o worst_aligned_U4_neat $results/tmp --incl-homs --incl-fail  -t $reads/NA12878_GIAB_highconf_IllFB-IllGATKHC-CG-Ion-Solid_ALLCHROM_v3.2.2_highconf.bed -T 90 --vcf-out --no-plot
END=$(date +%s)
DIFF=$(( $END - $START ))
exitcode=$?
