...
# Simulation-specific
targeted_region=/home/groups/hpcbio_shared/azza/TargetedRegions-Azza-has-permission/Intersect.TruseqTargeted_with_PlatinumConfident.bed
known_variants=/home/groups/hpcbio_shared/azza/TargetedRegions-Azza-has-permission/NA12877.vcf

OutputDir=/home/groups/hpcbio_shared/azza/human_WES_multi_sample_synthetic/data/reads/rare_variants
DatasetName=synthetic_rare_variants
...
do
	...
	NeatParams="-R 100 -c 5 -E 0.01 -p 2 -t $targeted_region -v $known_variants --pe 300 30 --bam --vcf --rng ${random_number} "
