...
java -Xmx8G -jar $picard MarkIlluminaAdapters I=unmappedbam.sam O=markilluminaadapters.bam M=markilluminaadapters_metrics.txt TMP_DIR=$results/tmp #O and M are the outputs from this command!
...
##### Unpiped processing:
java -Xmx8G -jar $picard SamToFastq I=markilluminaadapters.bam FASTQ=read1_cleaned.fq SECOND_END_FASTQ=read2_cleaned.fq CLIPPING_ATTRIBUTE=XT  CLIPPING_ACTION=2 NON_PF=true 
